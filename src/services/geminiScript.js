    ...
    **중요 지침**: 
    ...
    2. "script": 
       ...
       - [핵심 요구사항]
         ...
         - **이미지 매칭 마커**: 대본의 흐름에 따라 10개의 이미지 프롬프트와 매칭되는 지점에 **[1]부터 [10]까지의 숫자 마커**를 반드시 기입해 주세요. (예: "오늘의 주요 내용입니다. [1] 첫 번째 소식은...")
         - **특정 매체, 통신사 및 인물 언급 금지**: SBS, MBC, KBS, CNN, BBC, 연합뉴스, 뉴스1 등 특정 방송사, 언론 매체, 통신사의 이름, 그리고 기자의 이름이나 특정 인물의 성함을 대본에 절대 포함하지 마세요.
         - **시청자 호칭 사용 금지**: "시청자 여러분", "여러분 안녕하세요" 등 청중을 직접적으로 부르는 호칭이나 인사를 절대 포함하지 마세요.
         - **주의**: 위 이미지 마커([1]~[10])를 제외한 일반적인 번호 매기기(1., 2. 등)는 절대 하지 마세요.
